 ...
 *
 */
public class BlockAndesitePolished extends TBlock {
    private IIcon blockIconSide;

	/**
	 * 
	 */
	public BlockAndesitePolished() {
		super("stone_andesite_smooth");
	}
    ...
    public void registerBlockIcons(IIconRegister iconRegister) {
    	...
    	blockIconSide = iconRegister.registerIcon(Identity.MOD_ID + ":" + "double_stone_andesite_smooth");
    }
